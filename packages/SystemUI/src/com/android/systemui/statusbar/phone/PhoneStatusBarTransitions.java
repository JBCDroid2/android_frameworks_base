...
public final class PhoneStatusBarTransitions extends BarTransitions {
    ...
    private View mLeftSide, mStatusIcons, mSignalCluster, mBattery, mClock, mNetworkTraffic, mViperLogoRight, mViperLogoLeft;
    ...
    public void init() {
		...
		mViperLogoRight = mView.findViewById(R.id.viper_logo);
